                ...
                if !selected {
                    Form {
                        Section {
                            ...
                            Text("To import configurations from your iPhone or iPad, make sure Chorus Box is the **same version** on both devices and **VPN is disabled**.")
                        }

                        DevicePicker(
                            .applicationService(name: "Chorus Box:profile"))
                        { endpoint in
                            selected = true
                            Task {
