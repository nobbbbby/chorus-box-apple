...
public final class ChorusBoxMobileAppDelegate: NSObject, UIApplicationDelegate {
    ...
    public func application(
        ...
        configureVariant()
        NSLog("Here I stand")
        LibboxBootstrapper.bootstrap(isTVOS: application.supportsTVMode)
        #if !os(tvOS)
    ...
    private func configureVariant() {
        ChorusBoxConfiguration.configureIfNeeded {
            #if os(tvOS)
...
open class ChorusBoxMacAppDelegate: NSObject, NSApplicationDelegate, UNUserNotificationCenterDelegate {
    ...
    public func applicationDidFinishLaunching(_ notification: Notification) {
        configureVariant()
        NSLog("Here I stand")
        LibboxBootstrapper.bootstrap(isTVOS: false)
    ...
    private func adjustActivationPolicy() {
...
public final class ChorusBoxStandaloneAppDelegate: ChorusBoxMacAppDelegate {
    public override func applicationWillFinishLaunching(_ notification: Notification) {
        configureStandaloneVariant()
        Task { await setupSystemExtension() }
    }

    private func configureStandaloneVariant() {
